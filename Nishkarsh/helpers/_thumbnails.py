...
from Nishkarsh import config
from Nishkarsh.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("Nishkarsh/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("Nishkarsh/helpers/Inter-Light.ttf", 30)
    ...
    async def generate(self, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            channel_name = str(song.channel_name or "YouTube")
            view_count = str(song.view_count or "Unknown Views")
            title = str(song.title or "Unknown Title")
            duration = str(song.duration or "00:00")
